        ...
        <div className="bg-blue-800">
            <div className="py-8 px-4 sm:px-8 md:py-16 md:px-28 flex flex-wrap md:flex-nowrap justify-center">
                ...
                <ul className="w-full md:w-1/3">
                    ...
                    <li className="text-white text-base leading-8 pb-4 flex items-center"><FaHome className="text-3xl mr-3" />Đại Lộ Khoa Học, TP. Quy Nhơn</li>
                    <li className="text-white text-base leading-8 pb-4 flex items-center"><IoMdMail className="text-3xl mr-3" />motobikes@gmail.com</li>
                    <li className="text-white text-base leading-8 pb-4 flex items-center"><FaPhoneAlt className="text-3xl mr-3" />0123456789</li>
                    <li className="text-white text-base leading-8 pb-4 flex items-center"><GoClockFill className="text-3xl mr-3" /><span>08:00 AM - 17:30 PM</span></li>
                </ul>
            </div>
