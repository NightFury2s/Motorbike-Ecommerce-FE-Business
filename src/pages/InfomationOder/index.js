        ...
        <div className="informationOder">
            ...
            <div className="informationOder-infor-container">
                ...
                <div className="informationOder-infor-container-body">
                    <p className="informationOder-infor-container-body-name">{user.fullName}</p>
                    <p className="informationOder-infor-container-body-name">{user.phoneNumber}</p>
                    <p className="informationOder-infor-container-body-name">{user.email}</p>
                    <p className="informationOder-infor-container-body-name">{user.address}</p>
                </div>
            </div>
