    ...
    return (
        <div style={style} className="relative flex justify-center m-10">
            <div  style={{width:'100%',margin:'0 3px '}} className=" w-80 bg-[#f9f9f9] rounded-lg shadow-md relative">
                ...
                {product.discount && (
                    <div style={{color:'white'}} className="absolute top-0 right-0 bg-[#2B92E4] text-black font-medium px-2 rounded">
                        {product.discount}%
                    </div>
                )}
                ...
                <div className="px-7 pb-5 text-center">
                    ...
                    {product && product.originalPrice && (
                        <div className="flex justify-between items-center my-3">
                            <span className="text-[12px] font-bold text-[#FF0000]">
                                {product.newPrice.toLocaleString('vi-VN')} <span>VND</span>
                            </span>
                            <span className="text-[10px] font-bold text-[#777777] line-through">
