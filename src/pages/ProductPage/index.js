...
function ProductPage() {
  ...
  const [apiFiter, setApiFiter] = useState("1");
  const [link,setLink] = useState('/productcar/getsome')
    ...
    console.log('apiFiter ' ,apiFiter);
    console.log('motorbikeProducts ' ,motorbikeProducts);
  ...
  return (
    <div className="ProductPage-container">
      <h1 className="ProductPage-name">Xe Máy</h1>
      ...
      <div className="ProductPage-content">
        <div className="ProductPage-content-filter">
          ...
          <FilterProduct filter={filterMoto} setApiFiter={setApiFiter} SetCurrentPage={SetCurrentPage} setLink ={setLink} />
          <FilterProduct filter={filterAccessary} setApiFiter={setApiFiter} setLink={setLink} SetCurrentPage={SetCurrentPage} />
        </div>

        <div className="ProductPage-content-main">
          {motorbikeProducts &&
            motorbikeProducts.map((product, index) => (
                <div style={{width:'25%',marginBottom:'5px'}} >
                    <ProductCard key={index} product={product} />
                </div>
            ))}
            <div style={{display:'flex',justifyContent:'center', width: '100%', marginTop:'30px',zIndex:'1'}} >
