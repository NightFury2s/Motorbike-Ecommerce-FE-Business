  ...
  return (
    <div className="ProductPage-container">
      <div className="ProductPage-name">
        <h6 style={{position: 'absolute',zIndex:'1',backgroundColor: '#d9d9d9',padding:'0px 20px'}} > Xe Máy </h6>
        ...
        <div className="ProductPage-content-main">
          {motorbikeProducts &&
            motorbikeProducts.map((product, index) => (
                <div key={product.id} style={{width:'24.5%',margin:"0 2px 7px" , overflow:"hidden"}} >
