...
const RegisterModal = ({ setShowModal, setShowLoginModal }) => {
  ...
  return (
    ...
    >
      <div
        id="modal-content"
        className="flex flex-col rounded-2xl items-center text-center"
      >
              ...
              >
                ...
                <InputComponent
                  ...
                  pattern={{
                    ...
                    message:
                      "Mật khẩu bắt buộc gồm số, chữ cái thường, chữ cái hoa, ký hiệu",
                  }}
                />
                ...
                <button style={{width:'180px',marginLeft:"50%",transform:'translateX(-50%)',marginTop:'5px',color:'black',border:'2px solid black'}} className="border-2 border-[#2B92E4] text-[#2B92E4] rounded-full px-12 py-2 inline-block font-semibold hover:bg-[#2B92E4] hover:text-white">
                  Đăng ký
                </button>
              </div>
            </form>
